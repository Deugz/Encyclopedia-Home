...
Données brutes, faits ou détails sur quelque chose. 
...
```{image} ../../../_static/Svg_icons/down-arrow-1-svgrepo-com.svg
:width: 20%
:align: center
```
...
:::{dropdown} Connaissance


Compréhension de l'information. Elle implique une analyse, une interprétation et une synthèse de l'information
...
Ensembles spécifiques de connaissances 
...
<p class="emphase2"><strong>Etats des lieux</strong></p>

J'aimerai qu'on s'arrète quelques instants pour disséquer nos pratiques étudiantes avec [David Louapre](https://fr.wikipedia.org/wiki/David_Louapre) de la chaine youtube [ScienceEtonnante](https://www.youtube.com/channel/UCaNlbnghtwlsGF-KzAFThqA)
...
<p class="emphase">Voyons plus en détails les concepts abordés dans la vidéo</p>
...
<p class="emphase2"><strong>L'Ingénieurie Pédagogique </strong></p>

```{admonition} Ingénieurie pédagogique
:class: dropdown
...
:::::::{dropdown} Les différents modèles d'ingénieurie Pédagogique (in English)

::::::{tab-set}

:::::{tab-item} Situated Cognition Theory
...
:::::{tab-item} Sociocultural Learning Theory
...
:::::{tab-item} Merrill's Principles Of Instruction
...
:::::{tab-item} Discovery-Based Learning
...
:::::{tab-item}  Inquiry-Based Learning
...
:::::{tab-item} Individualized Instruction
...
:::::{tab-item}  Bloom’s Taxonomy Of Learning Objectives
...
Extracted from [this site](https://elearningindustry.com/top-instructional-design-theories-models-next-elearning-course)
...
<p class="emphase2"><strong>Construire des Connaissances</strong> </p>
...
<p class="emphase2"><strong>Batir des Savoirs </strong></p>
